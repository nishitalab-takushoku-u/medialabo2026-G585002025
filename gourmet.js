...
function print(data) {
  let shop = data.results.shop;
    ...
    console.log(shop[0].catch);
    console.log(shop[0].genre.name);
    console.log(shop[0].sub_genre.name);
    console.log(shop[0].budget.name);
    console.log(shop[0].open);
    console.log(shop[0].station_name);
    console.log(shop[0].access);
    console.log(shop[0].address);

    console.log(shop[1].name);
    console.log(shop[1].catch);
    console.log(shop[1].genre.name);
    console.log(shop[1].sub_genre.name);
    console.log(shop[1].budget.name);
    console.log(shop[1].open);
    console.log(shop[1].station_name);
    console.log(shop[1].access);
    console.log(shop[1].address);
}
